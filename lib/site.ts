...
export const SITE = {
  ...
  url: SITE_URL,
  social: {
    facebook: "https://www.facebook.com/uatpvtltd",
    linkedin: "https://www.linkedin.com/company/uat-pvt-ltd/",
    instagram: "https://www.instagram.com/uatpvtltd/",
    x: "https://x.com/uatpvtltd",
  },
} as const;
...
export const HERO_SLIDES: HeroSlide[] = [
  { kicker: "Air Pollution Control", title: "Manufacturer of Air Pollution Control & HVAC Equipment", sub: "Dust collectors, bag houses & scrubbers engineered to keep your emissions compliant and your plant safe.", image: "/img/slider/Pulse-Jet-Bag-Filter.jpg1.webp" },
  ...
  { kicker: "Air Pollution Control", title: "Manufacturer of Air Pollution Control & HVAC Equipment", sub: "Dust collectors, bag houses & scrubbers engineered to keep your emissions compliant and your plant safe.", image: "/img/slider/hybrid-scrubber-hero.png" },
  { kicker: "Ventilation", title: "Axial, Inline & Cabinet Fans", sub: "High-volume ventilation airflow across the full range of pressures and duties.", image: "/img/slider/Tube-Axial-Fan.jpg" },
